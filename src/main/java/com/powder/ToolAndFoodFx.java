...
public class ToolAndFoodFX extends JavaPlugin implements Listener
{
	...
	protected static boolean isArmor(ItemStack m) {
		...
		case PUMPKIN: case CARVED_PUMPKIN: case TURTLE_SHELL: case SKULL: case ELYTRA: case BOW: case CROSSBOW: case SHIELD:
		case WHITE_STAINED_GLASS: case ORANGE_STAINED_GLASS: case LIGHT_BLUE_STAINED_GLASS: case MAGENTA_STAINED_GLASS:
		case LIME_STAINED_GLASS: case YELLOW_STAINED_GLASS: case PINK_STAINED_GLASS: case GRAY_STAINED_GLASS: case LIGHT_GRAY_STAINED_GLASS:
		case CYAN_STAINED_GLASS: case PURPLE_STAINED_GLASS: case BLUE_STAINED_GLASS: case BROWN_STAINED_GLASS: case GREEN_STAINED_GLASS:
		case RED_STAINED_GLASS: case BLACK_STAINED_GLASS:
			return true;
		default:
			break;
		}
	...
	protected static boolean isWeapon(ItemStack m)
	{
		...
		case WOOD_SHOVEL: case WOOD_AXE: case WOOD_PICKAXE: case WOOD_HOE: case WOOD_SWORD:
		case STONE_SHOVEL: case STONE_AXE: case STONE_PICKAXE: case STONE_HOE: case STONE_SWORD:
		case IRON_SHOVEL: case IRON_AXE: case IRON_PICKAXE: case IRON_HOE: case IRON_SWORD:
		case GOLD_SHOVEL: case GOLD_AXE: case GOLD_PICKAXE: case GOLD_HOE: case GOLD_SWORD:
		case DIAMOND_SHOVEL: case DIAMOND_AXE: case DIAMOND_PICKAXE: case DIAMOND_HOE: case DIAMOND_SWORD:
		case NETHERITE_SHOVEL: case NETHERITE_AXE: case NETHERITE_PICKAXE: case NETHERITE_HOE: case NETHERITE_SWORD:
		case FLINT_AND_STEEL: case SHEARS: case STICK: case BOW: CROSSBOW: case: TRIDENT: case FISHING_ROD: case CARROT_ON_A_STICK:
		case WARPED_FUNGUS_ON_A_STICK: case DEBUG_STICK: case: DEADBUSH:
