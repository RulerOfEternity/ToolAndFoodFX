...
public class ToolAndFoodFX extends JavaPlugin implements Listener
{
	...
	protected static boolean isArmor(ItemStack m) {
		...
		case PUMPKIN: case CARVED_PUMPKIN: case TURTLE_SHELL: case SKULL: case ELYTRA: case BOW: case SHIELD:
	...
	protected static boolean isWeapon(ItemStack m)
	{
		...
		case FLINT_AND_STEEL: case SHEARS: case STICK: case: CROSSBOW: case: TRIDENT: case FISHING_ROD: case CARROT_ON_A_STICK:
